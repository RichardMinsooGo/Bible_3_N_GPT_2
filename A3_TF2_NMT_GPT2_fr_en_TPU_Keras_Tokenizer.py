...
'''
D13. [Not Formal] Build GPT-2 Inputs, Outputs
'''
...
'''
M16. [On Testing] Explore the training result with new raw sentence
'''
"""
def evaluate(text):
...
'''
M17. [PASS] Explore the training result with test dataset
'''
